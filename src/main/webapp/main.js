...
module.exports = "\r\n  <div class=\"app-title\">\r\n    <div>\r\n      <h1><i class=\"fa fa-dashboard\"></i> Dashboard</h1>\r\n      <p>Medintu Web Application</p>\r\n    </div>\r\n    <ul class=\"app-breadcrumb breadcrumb\">\r\n      <li class=\"breadcrumb-item\"><i class=\"fa fa-home fa-lg\"></i></li>\r\n      <li class=\"breadcrumb-item\"><a href=\"#\">Dashboard</a></li>\r\n    </ul>\r\n  </div>\r\n\r\n <div class=\"row\">\r\n    <div class=\"col-md-6 col-lg-3\">\r\n      <div class=\"widget-small primary coloured-icon\"><i class=\"icon fa fa-plus fa-3x\"></i>\r\n        <div class=\"info\">\r\n          <h4>Order Placed</h4>\r\n          <p><b>{{dashData.orderplaced}}</b></p>\r\n        </div>\r\n      </div>\r\n    </div>\r\n    <div class=\"col-md-6 col-lg-3\">\r\n      <div class=\"widget-small info coloured-icon\"><i class=\"icon fa fa-share-o-up fa-share\"></i>\r\n        <div class=\"info\">\r\n          <h4>Order Dispached</h4>\r\n          <p><b>{{dashData.orderDispatched}}</b></p>\r\n        </div>\r\n      </div>\r\n    </div>\r\n    <div class=\"col-md-6 col-lg-3\">\r\n      <div class=\"widget-small warning coloured-icon\"><i class=\"icon fa fa-superpowers-o fa-superpowers\"></i>\r\n        <div class=\"info\">\r\n          <h4>Non Reactive</h4>\r\n          <p><b>{{dashData.resultNonReactive}}</b></p>\r\n        </div>\r\n      </div>\r\n    </div>\r\n    <div class=\"col-md-6 col-lg-3\">\r\n      <div class=\"widget-small danger coloured-icon\"><i class=\"icon fa fa-bolt fa-bolt\"></i>\r\n        <div class=\"info\">\r\n          <h4>Reactive</h4>\r\n          <p><b>{{dashData.resultReactive}}</b></p>\r\n        </div>\r\n      </div>\r\n    </div>\r\n    <div class=\"col-md-6 col-lg-3\" data-toggle=\"modal\" data-target=\"#myModalspentbudget\" data-backdrop=\"static\" *ngIf=\"role=='SUPERADMIN'\">\r\n      <div class=\"widget-small info coloured-icon\"><i class=\"icon fa fa-money fa-money\"></i>\r\n        <div class=\"info\">\r\n          <h4>Budget Spent</h4>\r\n          <p><b>{{dashData.sponsorBudgetSpent}}</b></p>\r\n        </div>\r\n      </div>\r\n    </div>\r\n    <div class=\"col-md-6 col-lg-3\" data-toggle=\"modal\" data-target=\"#myModalspentbudget\" data-backdrop=\"static\"  *ngIf=\"role=='ADMIN'\">\r\n        <div class=\"widget-small info coloured-icon\"><i class=\"icon fa fa-money fa-money\"></i>\r\n          <div class=\"info\">\r\n            <h4>Budget Spent</h4>\r\n            <p><b>{{dashData.sponsorBudgetSpent}}</b></p>\r\n          </div>\r\n        </div>\r\n      </div>\r\n      <div class=\"col-md-6 col-lg-3\" data-toggle=\"modal\" data-target=\"#myModalspentbudget\" data-backdrop=\"static\"  *ngIf=\"role=='COMMISSIONERUSER'\">\r\n          <div class=\"widget-small info coloured-icon\"><i class=\"icon fa fa-money fa-money\"></i>\r\n            <div class=\"info\">\r\n              <h4>Budget Spent</h4>\r\n              <p><b>{{dashData.sponsorBudgetSpent}}</b></p>\r\n            </div>\r\n          </div>\r\n        </div>\r\n        <div class=\"col-md-6 col-lg-3\" data-toggle=\"modal\" data-target=\"#myModalspentbudget\" data-backdrop=\"static\"  *ngIf=\"role=='SUPPORTUSER'\">\r\n            <div class=\"widget-small info coloured-icon\"><i class=\"icon fa fa-money fa-money\"></i>\r\n              <div class=\"info\">\r\n                <h4>Budget Spent</h4>\r\n                <p><b>{{dashData.sponsorBudgetSpent}}</b></p>\r\n              </div>\r\n            </div>\r\n          </div>\r\n\r\n    <!--Modal for spent limit supportuser -->\r\n    <div class=\"modal \" id=\"myModalspentbudget\" *ngIf=\"role=='SUPPORTUSER'\">\r\n        <div class=\"modal-dialog modal-lg\">\r\n          <div class=\"modal-content\">\r\n      \r\n            <!-- Modal Header -->\r\n            <div class=\"modal-header\">\r\n              <h4 class=\"modal-title text-center\">Budget Spent</h4>\r\n              <button type=\"button\" class=\"close\" data-dismiss=\"modal\">&times;</button>\r\n            </div>\r\n      \r\n            <!-- Modal body -->\r\n            <div class=\"modal-body\">\r\n             <table class=\"table table-bordered table-striped\">\r\n               <thead>\r\n                 <th>#</th>\r\n                 <th>Order Id</th>\r\n                 <th>Sponsor Name</th>\r\n                 <th>Budget Spent</th>\r\n                 <th>Transaction Date</th>\r\n               </thead>\r\n               <tbody>\r\n                 <tr *ngFor=\"let item of commissionerspentdata |paginate: { itemsPerPage: 10, currentPage: p };let i=index\">\r\n                <td>{{i+1}}</td>\r\n                 <td>{{item.orderId}}</td>\r\n                 <td>{{item.sponsorName}}</td>\r\n                 <td>{{item.budgetSpent | currency:'GBP': true}}</td>\r\n                 <td>{{item.txDate|date: 'dd-MM-yyyy'}}</td>\r\n                </tr>\r\n               </tbody>\r\n             </table>\r\n             <pagination-controls (pageChange)=\"p = $event\" class=\"pull-right\"></pagination-controls>\r\n            </div>\r\n      \r\n            <!-- Modal footer -->\r\n            <div class=\"modal-footer\">\r\n              <button type=\"button\" class=\"btn btn-danger\" data-dismiss=\"modal\">Close</button>\r\n            </div>\r\n      \r\n          </div>\r\n        </div>\r\n      </div>\r\n      <!--Modal for spent limit Ends -->\r\n\r\n       <!--Modal for spent limit for CommissionerUser-->\r\n    <div class=\"modal \" id=\"myModalspentbudget\" *ngIf=\"role=='COMMISSIONERUSER'\">\r\n        <div class=\"modal-dialog modal-lg\">\r\n          <div class=\"modal-content\">\r\n      \r\n            <!-- Modal Header -->\r\n            <div class=\"modal-header\">\r\n              <h4 class=\"modal-title text-center\">Budget Spent</h4>\r\n              <button type=\"button\" class=\"close\" data-dismiss=\"modal\">&times;</button>\r\n            </div>\r\n      \r\n            <!-- Modal body -->\r\n            <div class=\"modal-body\">\r\n             <table class=\"table table-bordered table-striped\">\r\n               <thead>\r\n                 <th>#</th>\r\n                 <th>Order Id</th>\r\n                 <th>Sponsor Name</th>\r\n                 <th>Budget Spent</th>\r\n                 <th>Transaction Date</th>\r\n               </thead>\r\n               <tbody>\r\n                 <tr *ngFor=\"let item of commissionerspentdata |paginate: { itemsPerPage: 10, currentPage: p };let i=index\">\r\n                <td>{{i+1}}</td>\r\n                 <td>{{item.orderId}}</td>\r\n                 <td>{{item.sponsorName}}</td>\r\n                 <td>{{item.budgetSpent | currency:'GBP': true}}</td>\r\n                 <td>{{item.txDate|date: 'dd-MM-yyyy'}}</td>\r\n                </tr>\r\n               </tbody>\r\n             </table>\r\n             <pagination-controls (pageChange)=\"p = $event\" class=\"pull-right\"></pagination-controls>\r\n            </div>\r\n      \r\n            <!-- Modal footer -->\r\n            <div class=\"modal-footer\">\r\n              <button type=\"button\" class=\"btn btn-danger\" data-dismiss=\"modal\">Close</button>\r\n            </div>\r\n      \r\n          </div>\r\n        </div>\r\n      </div>\r\n      <!--Modal for spent limit Ends -->\r\n\r\n  <!--Modal for spent limit for ADMIN-->\r\n  <div class=\"modal \" id=\"myModalspentbudget\" *ngIf=\"role=='ADMIN'\">\r\n      <div class=\"modal-dialog modal-lg\">\r\n        <div class=\"modal-content\">\r\n    \r\n          <!-- Modal Header -->\r\n          <div class=\"modal-header\">\r\n            <h4 class=\"modal-title text-center\">Budget Spent</h4>\r\n            <button type=\"button\" class=\"close\" data-dismiss=\"modal\">&times;</button>\r\n          </div>\r\n    \r\n          <!-- Modal body -->\r\n          <div class=\"modal-body\">\r\n           <table class=\"table table-bordered table-striped\">\r\n             <thead>\r\n               <th>#</th>\r\n               <th>Order Id</th>\r\n               <th>Sponsor Name</th>\r\n               <th>Budget Spent</th>\r\n               <th>Transaction Date</th>\r\n             </thead>\r\n             <tbody>\r\n               <tr *ngFor=\"let item of commissionerspentdata |paginate: { itemsPerPage: 10, currentPage: p };let i=index\">\r\n              <td>{{i+1}}</td>\r\n               <td>{{item.orderId}}</td>\r\n               <td>{{item.sponsorName}}</td>\r\n               <td>{{item.budgetSpent | currency:'GBP': true}}</td>\r\n               <td>{{item.txDate|date: 'dd-MM-yyyy'}}</td>\r\n              </tr>\r\n             </tbody>\r\n           </table>\r\n           <pagination-controls (pageChange)=\"p = $event\" class=\"pull-right\"></pagination-controls>\r\n          </div>\r\n    \r\n          <!-- Modal footer -->\r\n          <div class=\"modal-footer\">\r\n            <button type=\"button\" class=\"btn btn-danger\" data-dismiss=\"modal\">Close</button>\r\n          </div>\r\n    \r\n        </div>\r\n      </div>\r\n    </div>\r\n    <!--Modal for spent limit Ends -->\r\n\r\n    \r\n  <!--Modal for spent limit for SUPERADMIN-->\r\n  <div class=\"modal \" id=\"myModalspentbudget\" *ngIf=\"role=='SUPERADMIN'\">\r\n      <div class=\"modal-dialog modal-lg\">\r\n        <div class=\"modal-content\">\r\n    \r\n          <!-- Modal Header -->\r\n          <div class=\"modal-header\">\r\n            <h4 class=\"modal-title text-center\">Budget Spent</h4>\r\n            <button type=\"button\" class=\"close\" data-dismiss=\"modal\">&times;</button>\r\n          </div>\r\n    \r\n          <!-- Modal body -->\r\n          <div class=\"modal-body\">\r\n           <table class=\"table table-bordered table-striped\">\r\n             <thead>\r\n               <th>#</th>\r\n               <th>Order Id</th>\r\n               <th>Sponsor Name</th>\r\n               <th>Budget Spent</th>\r\n               <th>Transaction Date</th>\r\n             </thead>\r\n             <tbody>\r\n               <tr *ngFor=\"let item of commissionerspentdata |paginate: { itemsPerPage: 10, currentPage: p };let i=index\">\r\n              <td>{{i+1}}</td>\r\n               <td>{{item.orderId}}</td>\r\n               <td>{{item.sponsorName}}</td>\r\n               <td>{{item.budgetSpent | currency:'GBP': true}}</td>\r\n               <td>{{item.txDate|date: 'dd-MM-yyyy'}}</td>\r\n              </tr>\r\n             </tbody>\r\n           </table>\r\n           <pagination-controls (pageChange)=\"p = $event\" class=\"pull-right\"></pagination-controls>\r\n          </div>\r\n    \r\n          <!-- Modal footer -->\r\n          <div class=\"modal-footer\">\r\n            <button type=\"button\" class=\"btn btn-danger\" data-dismiss=\"modal\">Close</button>\r\n          </div>\r\n    \r\n        </div>\r\n      </div>\r\n    </div>\r\n    <!--Modal for spent limit Ends -->\r\n      \r\n\r\n    <div class=\"col-md-6 col-lg-3\">\r\n      <div class=\"widget-small warning coloured-icon\"><i class=\"icon fa fa-money fa-money\"></i>\r\n        <div class=\"info\">\r\n          <h4>Budget Remaining</h4>\r\n          <p><b>{{dashData.sponsorBudgetRemaining}}</b></p>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n  <div class=\"row\">\r\n    <div class=\"col-md-6\">\r\n      <div class=\"tile\">\r\n        <h3 class=\"tile-title\">Sampling Kit</h3>\r\n        <div class=\"embed-responsive embed-responsive-16by9\">\r\n          <canvas class=\"embed-responsive-item\" id=\"lineChartDemo\"></canvas>\r\n        </div>\r\n      </div>\r\n    </div>\r\n    <div class=\"col-md-6\">\r\n      <div class=\"tile\">\r\n        <h3 class=\"tile-title\">Sampling Kit</h3>\r\n        <div class=\"embed-responsive embed-responsive-16by9\">\r\n          <canvas class=\"embed-responsive-item\" id=\"pieChartDemo\"></canvas>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n\r\n\r\n"
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.getDashData = function () {
        ...
        this.DataService.getDashboardData(this.sponsorId).subscribe(function (response) {
            _this.dashData = response.resultData;
        });
    };
    DashboardComponent.prototype.getSpendListforSponsor = function () {
        var _this = this;
        this.sponsorId = sessionStorage.getItem('sponsorId');
        this.DataService.getsponsorDashboardspentList(this.sponsorId).subscribe(function (res) {
            _this.commissionerspentdata = res.resultData;
        });
    };
...
var SponsorUserComponent = /** @class */ (function () {
    function SponsorUserComponent(fb, DataService) {
        ...
        this.subItem = [];
        this.loopethnicode = [];
        this.loopethniccodeid = [];
        this.genderdata = ['Man', 'Woman', 'Transman', 'Transwoman'];
    ...
    SponsorUserComponent.prototype.getAllEthenic = function () {
        ...
        this.DataService.getEthenic().subscribe(function (data) {
            _this.ethenicData = data.resultData;
            console.log("All ethnic data", _this.ethenicData);
        });
    };
    ...
    SponsorUserComponent.prototype.getAllTestCodeDetails = function () {
        ...
        this.DataService.getAllTestCodeDetails().subscribe(function (response) {
            ...
            console.log("Test code details", _this.testCodeData);
        });
    };
...
var SponsordetailsComponent = /** @class */ (function () {
    ...
    SponsordetailsComponent.prototype.getSponsorbyId = function () {
        ...
        this.dataservice.getSponsorbyId(sessionStorage.getItem('sponsorId')).subscribe(function (data) {
            ...
            _this.ethnicGroupDetails = _this.sponsorDetailsRule.ethnicGroups;
            console.log("Rules details", _this.sponsorDetailsRule);
            //address details
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2luZGV4L2hlYWRlci9oZWFkZXIuY29tcG9uZW50LnNjc3MifQ== */"
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(authService, routerNavigate) {
        this.authService = authService;
        this.routerNavigate = routerNavigate;
    }
...
var IndexComponent = /** @class */ (function () {
    function IndexComponent(authService, routerNavigate) {
        this.authService = authService;
        this.routerNavigate = routerNavigate;
    }
...
/* harmony import */ var _internalerror_internalerror_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./internalerror/internalerror.component */ "./src/app/index/internalerror/internalerror.component.ts");
/* harmony import */ var _header_header_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./header/header.component */ "./src/app/index/header/header.component.ts");
...
/* harmony import */ var _internalerror_internalerror_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./internalerror/internalerror.component */ "./src/app/index/internalerror/internalerror.component.ts");
/* harmony import */ var _checkpostal_checkpostal_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkpostal/checkpostal.component */ "./src/app/index/checkpostal/checkpostal.component.ts");
/* harmony import */ var _pagenotfound_pagenotfound_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pagenotfound/pagenotfound.component */ "./src/app/index/pagenotfound/pagenotfound.component.ts");
/* harmony import */ var _postcodeerror_postcodeerror_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./postcodeerror/postcodeerror.component */ "./src/app/index/postcodeerror/postcodeerror.component.ts");
/* harmony import */ var _final_final_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./final/final.component */ "./src/app/index/final/final.component.ts");
/* harmony import */ var _more_detail_more_detail_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./more-detail/more-detail.component */ "./src/app/index/more-detail/more-detail.component.ts");
/* harmony import */ var _questions_questions_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./questions/questions.component */ "./src/app/index/questions/questions.component.ts");
/* harmony import */ var _address_address_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./address/address.component */ "./src/app/index/address/address.component.ts");
/* harmony import */ var _test_test_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./test/test.component */ "./src/app/index/test/test.component.ts");
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./login/login.component */ "./src/app/index/login/login.component.ts");
/* harmony import */ var _sign_up_sign_up_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./sign-up/sign-up.component */ "./src/app/index/sign-up/sign-up.component.ts");
/* harmony import */ var _index_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./index.component */ "./src/app/index/index.component.ts");
/* harmony import */ var _gaurds_login_guard__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../gaurds/login.guard */ "./src/app/gaurds/login.guard.ts");
/* harmony import */ var _result_result_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./result/result.component */ "./src/app/index/result/result.component.ts");
/* harmony import */ var _person_details_person_details_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./person-details/person-details.component */ "./src/app/index/person-details/person-details.component.ts");
/* harmony import */ var _edit_details_edit_details_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./edit-details/edit-details.component */ "./src/app/index/edit-details/edit-details.component.ts");
/* harmony import */ var _viewresults_viewresults_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./viewresults/viewresults.component */ "./src/app/index/viewresults/viewresults.component.ts");
/* harmony import */ var _ageerror_ageerror_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./ageerror/ageerror.component */ "./src/app/index/ageerror/ageerror.component.ts");
/* harmony import */ var _login_action_page_login_action_page_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./login-action-page/login-action-page.component */ "./src/app/index/login-action-page/login-action-page.component.ts");
/* harmony import */ var _header_header_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./header/header.component */ "./src/app/index/header/header.component.ts");
...
var Indexroutes = [
    { path: '', component: _index_component__WEBPACK_IMPORTED_MODULE_11__["IndexComponent"], canActivate: [_gaurds_login_guard__WEBPACK_IMPORTED_MODULE_12__["LoginGuard"]],
        children: [
            { path: 'login', component: _login_login_component__WEBPACK_IMPORTED_MODULE_9__["LoginComponent"] },
            { path: 'login/:id', component: _login_login_component__WEBPACK_IMPORTED_MODULE_9__["LoginComponent"] },
            { path: 'sing-up', component: _sign_up_sign_up_component__WEBPACK_IMPORTED_MODULE_10__["SignUpComponent"] },
            { path: 'personsdetails', component: _person_details_person_details_component__WEBPACK_IMPORTED_MODULE_14__["PersonDetailsComponent"] },
            { path: 'personsdetails/:id', component: _person_details_person_details_component__WEBPACK_IMPORTED_MODULE_14__["PersonDetailsComponent"] },
            { path: 'test', component: _test_test_component__WEBPACK_IMPORTED_MODULE_8__["TestComponent"] },
            { path: 'address', component: _address_address_component__WEBPACK_IMPORTED_MODULE_7__["AddressComponent"] },
            { path: 'address/:id', component: _address_address_component__WEBPACK_IMPORTED_MODULE_7__["AddressComponent"] },
            { path: 'result/:id', component: _result_result_component__WEBPACK_IMPORTED_MODULE_13__["ResultComponent"] },
            { path: 'question', component: _questions_questions_component__WEBPACK_IMPORTED_MODULE_6__["QuestionsComponent"] },
            { path: 'checkpostal', component: _checkpostal_checkpostal_component__WEBPACK_IMPORTED_MODULE_1__["CheckpostalComponent"] },
            { path: 'moredetail', component: _more_detail_more_detail_component__WEBPACK_IMPORTED_MODULE_5__["MoreDetailComponent"] },
            { path: 'result', component: _result_result_component__WEBPACK_IMPORTED_MODULE_13__["ResultComponent"] },
            { path: 'edit', component: _edit_details_edit_details_component__WEBPACK_IMPORTED_MODULE_15__["EditDetailsComponent"] },
            { path: 'final', component: _final_final_component__WEBPACK_IMPORTED_MODULE_4__["FinalComponent"] },
            { path: 'not', component: _postcodeerror_postcodeerror_component__WEBPACK_IMPORTED_MODULE_3__["PostcodeerrorComponent"] },
            { path: 'pagenotfound', component: _pagenotfound_pagenotfound_component__WEBPACK_IMPORTED_MODULE_2__["PagenotfoundComponent"] },
            { path: 'final', component: _final_final_component__WEBPACK_IMPORTED_MODULE_4__["FinalComponent"] },
            { path: 'viewresults', component: _viewresults_viewresults_component__WEBPACK_IMPORTED_MODULE_16__["ViewresultsComponent"] },
            { path: 'loginpageaction', component: _login_action_page_login_action_page_component__WEBPACK_IMPORTED_MODULE_18__["LoginActionPageComponent"] },
            { path: 'ageerror', component: _ageerror_ageerror_component__WEBPACK_IMPORTED_MODULE_17__["AgeerrorComponent"] },
            { path: 'internal', component: _internalerror_internalerror_component__WEBPACK_IMPORTED_MODULE_0__["InternalerrorComponent"] },
            { path: 'header', component: _header_header_component__WEBPACK_IMPORTED_MODULE_19__["HeaderComponent"] }
        ]
    }
];
...
/***/ "./src/app/index/internalerror/internalerror.component.html":
/*!******************************************************************!*\
  !*** ./src/app/index/internalerror/internalerror.component.html ***!
  \******************************************************************/
/*! no static exports found */
...
module.exports = "<!-- Main Wrapper Start -->\r\n\r\n\r\n\r\n <!--about section area -->\r\n <div class=\"about_section mt-60\">\r\n    <div class=\"container\">  \r\n      <div class=\"row\">\r\n         <div class=\"col-lg-12 col-md-12\">\r\n              <div class=\"about_content text-left internal_error\">\r\n    \r\n                    <h2>There is a Internal Server Problem</h2>\r\n               \r\n              </div>\r\n          </div>\r\n       </div>\r\n    </div>     \r\n</div>\r\n<!--about section end-->\r\n\r\n\r\n\r\n<!--footer area start-->\r\n<footer class=\"footer_widgets\">\r\n  <div class=\"container\">\r\n    <div class=\"footer_top\">\r\n      <div class=\"row\">\r\n        <div class=\"col-lg-4 col-md-6 col-sm-7\">\r\n          <div class=\"widgets_container contact_us\">\r\n            <h3>Contacts us</h3>\r\n            <div class=\"footer_contact\">\r\n              <ul>\r\n                <li><i class=\"fa fa-home\"></i><span>Addresss:</span> Lorem Ipsum is simply dummy text of the printing\r\n                  and typesetting industry. Lorem Ipsum</li>\r\n                <li><i class=\"fa fa-phone\"></i><span>Phone:</span> (+91) 866-540-3229</li>\r\n                <li><i class=\"fa fa-envelope-square\"></i><span>Email:</span> info@Lorem Ipsum .com</li>\r\n              </ul>\r\n            </div>\r\n           \r\n          </div>\r\n        </div>\r\n        <div class=\"col-lg-2 col-md-6 col-sm-5\">\r\n          <div class=\"widgets_container widget_menu\">\r\n            <h3>Information</h3>\r\n          </div>\r\n        </div>\r\n        <div class=\"col-lg-6 col-md-4 col-sm-4\">\r\n          <div class=\"widgets_container widget_menu\">\r\n            <h3>My Account</h3>\r\n            <div class=\"footer_menu\">\r\n              <div class=\"footer_contact\">\r\n                <ul>\r\n                  <li> Proudly operated from Yorkshire by Preventx and MESMAC as the Nationally commissioned provider of\r\n                    HIV home-sampling screening. </li>\r\n                </ul>\r\n              </div>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n  <div class=\"footer_bottom\">\r\n    <div class=\"container\">\r\n      <div class=\"row\">\r\n        <div class=\"col-lg-12 col-md-12\">\r\n          <div class=\"copyright_area text-center\">\r\n            <p>Copyright &copy; 2019 <a href=\"#\">Medintu</a> All Right Reserved.</p>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</footer>"

/***/ }),

/***/ "./src/app/index/internalerror/internalerror.component.scss":
/*!******************************************************************!*\
  !*** ./src/app/index/internalerror/internalerror.component.scss ***!
  \******************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2luZGV4L2ludGVybmFsZXJyb3IvaW50ZXJuYWxlcnJvci5jb21wb25lbnQuc2NzcyJ9 */"

/***/ }),

/***/ "./src/app/index/internalerror/internalerror.component.ts":
/*!****************************************************************!*\
  !*** ./src/app/index/internalerror/internalerror.component.ts ***!
  \****************************************************************/
...
var InternalerrorComponent = /** @class */ (function () {
    ...
    InternalerrorComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./internalerror.component.html */ "./src/app/index/internalerror/internalerror.component.html"),
            styles: [__webpack_require__(/*! ./internalerror.component.scss */ "./src/app/index/internalerror/internalerror.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
...
var LoginActionPageComponent = /** @class */ (function () {
    ...
    LoginActionPageComponent.prototype.navigateToDashboard = function () {
...
module.exports = ".form-control {\n  box-shadow: none;\n  border-color: #ddd; }\n\n.form-control:focus {\n  border-color: #19aa8d; }\n\n.login-form {\n  width: 350px;\n  margin: 0 auto;\n  padding: 30px 0; }\n\n.login-form form {\n  color: #434343;\n  border-radius: 1px;\n  margin-bottom: 15px;\n  background: #fff;\n  border: 1px solid #f3f3f3;\n  box-shadow: 0px 2px 2px rgba(0, 0, 0, 0.3);\n  padding: 30px; }\n\n.login-form h4 {\n  text-align: center;\n  font-size: 22px;\n  margin-bottom: 20px; }\n\n.login-form .avatar {\n  color: #fff;\n  margin: 0 auto 30px;\n  text-align: center;\n  width: 100px;\n  height: 100px;\n  border-radius: 50%;\n  z-index: 9;\n  background: #19aa8d;\n  padding: 15px;\n  box-shadow: 0px 2px 2px rgba(0, 0, 0, 0.1); }\n\n.login-form .avatar i {\n  font-size: 62px; }\n\n.login-form .form-group {\n  margin-bottom: 20px; }\n\n.login-form .form-control, .login-form .btn {\n  min-height: 40px;\n  border-radius: 2px;\n  transition: all 0.5s; }\n\n.login-form .close {\n  position: absolute;\n  top: 15px;\n  right: 15px; }\n\n.login-form .btn {\n  background: #19aa8d;\n  border: none;\n  line-height: normal; }\n\n.login-form .btn:hover, .login-form .btn:focus {\n  background: #19aa8d; }\n\n.login-form .checkbox-inline {\n  float: left; }\n\n.login-form input[type=\"checkbox\"] {\n  margin-top: 2px; }\n\n.login-form .forgot-link {\n  float: right; }\n\n.login-form .small {\n  font-size: 13px; }\n\n.login-form a {\n  color: #19aa8d; }\n\n/*forgot password*/\n\n.modal-newsletter {\n  color: #999;\n  font-size: 15px; }\n\n.modal-newsletter .modal-content {\n  padding: 40px;\n  border-radius: 0;\n  border: none; }\n\n.modal-newsletter .modal-header {\n  border-bottom: none;\n  position: relative;\n  text-align: center;\n  border-radius: 5px 5px 0 0; }\n\n.modal-newsletter h4 {\n  color: #000;\n  text-align: center;\n  font-size: 30px;\n  margin: 0 0 25px;\n  font-weight: bold;\n  text-transform: capitalize; }\n\n.modal-newsletter .close {\n  background: #c0c3c8;\n  position: absolute;\n  top: -15px;\n  right: -15px;\n  color: #fff;\n  text-shadow: none;\n  opacity: 0.5;\n  width: 22px;\n  height: 22px;\n  border-radius: 20px;\n  font-size: 16px;\n  padding: 4px; }\n\n.modal-newsletter .close span {\n  position: relative;\n  top: -1px; }\n\n.modal-newsletter .close:hover {\n  opacity: 0.8; }\n\n.modal-newsletter .icon-box {\n  color: #19aa8d;\n  display: inline-block;\n  z-index: 9;\n  text-align: center;\n  position: relative;\n  margin-bottom: 10px;\n  margin-left: 130px; }\n\n.modal-newsletter .icon-box i {\n  font-size: 110px; }\n\n.modal-newsletter .form-control, .modal-newsletter .btn {\n  min-height: 46px;\n  border-radius: 3px; }\n\n.modal-newsletter .form-control {\n  box-shadow: none;\n  border-color: #dbdbdb; }\n\n.modal-newsletter .form-control:focus {\n  border-color: #19aa8d;\n  box-shadow: 0 0 8px #19aa8d; }\n\n.modal-newsletter .btn {\n  color: #fff;\n  border-radius: 4px;\n  background: #19aa8d;\n  text-decoration: none;\n  transition: all 0.4s;\n  line-height: normal;\n  padding: 6px 20px;\n  min-width: 150px;\n  border: none; }\n\n.modal-newsletter .btn:hover, .modal-newsletter .btn:focus {\n  background: #19aa8d;\n  outline: none; }\n\n.modal-newsletter .input-group {\n  margin: 30px 0 15px; }\n\n.hint-text {\n  margin: 100px auto;\n  text-align: center; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".round {\n  border-radius: 12px;\n  background-color: green;\n  color: white;\n  font-size: 12px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ViewresultsComponent = /** @class */ (function () {
    ...
    ViewresultsComponent.prototype.viewOrderResult = function (orderId, accessKey) {
        ...
        this.indexservice.getTestResult(orderId).subscribe(function (response) {
            _this.trackresult = response.resultData;
...
module.exports = ".navbar-header.col {\n  padding: 0 !important; }\n\n.navbar {\n  background: #fff;\n  padding-left: 16px;\n  padding-right: 16px;\n  border-bottom: 1px solid #dfe3e8;\n  border-radius: 0; }\n\n.navbar .navbar-brand {\n  font-size: 20px;\n  padding-left: 0;\n  padding-right: 50px; }\n\n.navbar .navbar-brand b {\n  font-weight: bold;\n  color: #29c68c; }\n\n.navbar ul.nav li a {\n  color: #999; }\n\n.navbar ul.nav li a:hover, .navbar ul.nav li a:focus {\n  color: #29c68c !important; }\n\n.navbar ul.nav li.active > a, .navbar ul.nav li.open > a {\n  color: #26bb84 !important;\n  background: transparent !important; }\n\n.navbar .form-inline .input-group-addon {\n  box-shadow: none;\n  border-radius: 2px 0 0 2px;\n  background: #f5f5f5;\n  border-color: #dfe3e8;\n  font-size: 16px; }\n\n.navbar .form-inline i {\n  font-size: 16px; }\n\n.navbar .form-inline .btn {\n  border-radius: 2px;\n  color: #fff;\n  border-color: #29c68c;\n  background: #29c68c;\n  outline: none; }\n\n.navbar .form-inline .btn:hover, .navbar .form-inline .btn:focus {\n  border-color: #26bb84;\n  background: #26bb84; }\n\n.navbar .search-form {\n  display: inline-block; }\n\n.navbar .search-form .btn {\n  margin-left: 4px; }\n\n.navbar .search-form .form-control {\n  border-radius: 2px; }\n\n.navbar .login-form .input-group {\n  margin-right: 4px;\n  float: left; }\n\n.navbar .login-form .form-control {\n  max-width: 158px;\n  border-radius: 0 2px 2px 0; }\n\n.navbar .navbar-right .dropdown-toggle::after {\n  display: none; }\n\n.navbar .dropdown-menu {\n  border-radius: 1px;\n  border-color: #e5e5e5;\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.05); }\n\n.navbar .dropdown-menu li a {\n  padding: 6px 20px; }\n\n.navbar .navbar-right .dropdown-menu {\n  width: 505px;\n  padding: 20px;\n  left: auto;\n  right: 0;\n  font-size: 14px; }\n\n@media (min-width: 1200px) {\n  .search-form .input-group {\n    width: 300px;\n    margin-left: 30px; } }\n\n@media (max-width: 768px) {\n  .navbar .navbar-right .dropdown-menu {\n    width: 100%;\n    background: transparent;\n    padding: 10px 20px; }\n  .navbar .input-group {\n    width: 100%;\n    margin-bottom: 15px; }\n  .navbar .input-group .form-control {\n    max-width: none; }\n  .navbar .login-form .btn {\n    width: 100%; } }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = __webpack_require__(/*! C:\Users\Administrator\Desktop\Lastest\samplingkit\SamplingKitUI\src\main.ts */"./src/main.ts");

...
module.exports = "<div class=\"app-title\">\n    <div>\n      <h1><i class=\"fa fa-th-list\"></i>Postalcode</h1>\n      <p>Create Postalcode</p>\n    </div>\n    <ul class=\"app-breadcrumb breadcrumb\">\n       <li class=\"breadcrumb-item\"><i class=\"fa fa-home fa-lg\"></i></li> \n    </ul>\n  </div>\n  \n  <div class=\"tile\">\n  <h5></h5>\n  <form class=\"form-inline row\">\n    <div class=\"col-sm-12\">\n        <button type=\"button\" style=\"margin-bottom:8px\" class=\"btn btn-danger pull-right\" data-toggle=\"modal\" data-target=\"#myModal\"\n        (click)=\"add(regForm)\">Add</button>\n    </div>\n  </form>\n  <div id=\"myModal\" class=\"modal fade\" role=\"dialog\">\n     <div class=\"modal-dialog\">\n       <!-- Modal content-->\n       <div class=\"modal-content\">\n         <div class=\"modal-header\">\n           <h4 class=\"modal-title\">Postal Code</h4>\n           <button type=\"button\" class=\"close\" data-dismiss=\"modal\">&times;</button>\n           \n         </div>\n         <div class=\"modal-body\">\n           <form #regForm='ngForm'>\n               <div class=\"col-md-6\">\n                   <label>\n                    Postal Code:\n                     <input type=\"text\" placeholder=\"Postal Code\" name=\"postalCode\" class=\"form-control\" [(ngModel)]= mpincode >\n                   </label>\n                 </div>\n                 <button type=\"submit\" data-dismiss=\"modal\" class=\"btn btn-primary float-right\" id=\"register\" (click)=\"savePostaldata(regForm.value)\" *ngIf=\"addfrm\">Submit</button>\n                 <button type=\"button\" data-dismiss=\"modal\" class=\"btn btn-primary float-right\" id=\"register\" (click)=\"updatePostalData()\" *ngIf=\"updatfrm\" >Update</button>\n           </form>\n         </div>\n         <div class=\"modal-footer\">\n           <!-- <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button> -->\n         </div>\n       </div>\n   \n     </div>\n   </div>\n  \n  \n  <table class=\"table table-striped\" >\n   <thead>\n     <tr style=\"font-size:15px\">\n       <th>Id</th>\n       <th>Postalcode</th>\n       <th>Edit</th>\n       <th>Delete</th>\n     </tr>\n   </thead>\n   <tbody>\n     <tr *ngFor = \"let data of postalCodes\">\n       <td>{{data.id}}</td>\n       <td>{{data.postalCode}}</td>\n       <td>\n         <span>\n           <span (click)=\"editPostal(data)\" data-toggle=\"modal\" data-target=\"#myModal\"  class=\"glyphicon glyphicon-pencil\">\n             <i class=\"fa fa-edit\" style=\"font-size:24px;color:rgb(49, 17, 233)\"></i>\n           </span>\n         </span>\n       </td>\n       <td>\n         <span>\n           <span (click)=\"deletePostalCode(data.id)\" value=\"delete\">\n             <i class=\"fa fa-trash\" style=\"font-size:24px;color:red\"></i>\n           </span>\n         </span>\n       </td>\n     </tr>\n   </tbody>\n  </table>\n  </div>"
...
var SponsorUserComponent = /** @class */ (function () {
    ...
    SponsorUserComponent.prototype.updateSponsorDetails = function (data) {
        var _this = this;
        this.DataService.updateSponsorDetails(data, this.sponsorId).subscribe(function (data) {
    ...
    SponsorUserComponent.prototype.ruleTable = function (selectedEthenicName, selectedGender, minage, maxage, selectedTestName) {
...
var SponsordetailsComponent = /** @class */ (function () {
    function SponsordetailsComponent(dataservice) {
        this.dataservice = dataservice;
        this.getSponsorbyId();
    }
    SponsordetailsComponent.prototype.getSponsorbyId = function () {
        ...
        this.dataservice.getSponsorbyId(sessionStorage.getItem('sponsorId')).subscribe(function (data) {
            ...
            _this.streetNumber = _this.sponsorDetails.addresses[0].streetNumber;
            _this.streetName1 = _this.sponsorDetails.addresses[0].streetName1;
            _this.streetName2 = _this.sponsorDetails.addresses[0].streetName2;
            _this.city = _this.sponsorDetails.addresses[0].city;
            _this.country = _this.sponsorDetails.addresses[0].country;
            _this.district = _this.sponsorDetails.addresses[0].district;
            _this.region = _this.sponsorDetails.addresses[0].region;
            _this.state = _this.sponsorDetails.addresses[0].state;
            _this.zipcode = _this.sponsorDetails.addresses[0].zipcode;
            _this.sponsorDetails = data.resultData.sponsor;
            _this.name = _this.sponsorDetails = data.resultData.sponsor.name;
            _this.phone = _this.sponsorDetails = data.resultData.sponsor.phone;
            _this.email = _this.sponsorDetails = data.resultData.sponsor.email;
            _this.budget = _this.sponsorDetails = data.resultData.sponsor.budget;
            _this.sponsorDetailsRule = data.resultData.rules;
    ...
    SponsordetailsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_data_service__WEBPACK_IMPORTED_MODULE_1__["DataService"]])
...
module.exports = "\n<div class=\"app-title\">\n    <div>\n      <h1><i class=\"fa fa-th-list\"></i> Test Code</h1>\n      <p>Test Code Details</p>\n    </div>\n    <ul class=\"app-breadcrumb breadcrumb\">\n    </ul>\n  </div>\n  <div class=\"tile\">\n  <span style=\"font-size: 25px;\">Test Code Details</span>\n  <button type=\"button\" class=\"btn btn-danger pull-right\" style=\"margin-bottom: 10px;\"  data-toggle=\"modal\" data-target=\"#myModal\">Add Test</button>\n  <table class=\"table\">\n      <thead>\n        <tr>\n          <th>#</th>\n          <th>Test Name</th>\n          <th>Test Code</th>\n          <th>Test Code Description</th>\n          <th>Edit</th>\n        </tr>\n      </thead>\n      <tbody>\n        <tr *ngFor='let item of testCodeData;let i=index'>\n          <td>\n            <div>{{i+1}}</div>\n          </td>\n          <td>\n            <div *ngIf=\"!item.isEditable\">{{item.testName}}</div>\n            <input  [(ngModel)]=\"item.testName\" *ngIf=\"item.isEditable\" type=\"text\" class=\"form-control\">\n          </td>\n          <td>\n            <div *ngIf=\"!item.isEditable\">{{item.testCode}}\n          </div>\n          <input  [(ngModel)]=\"item.testCode\" type=\"text\"  *ngIf=\"item.isEditable\" class=\"form-control\">\n        </td>\n          <td>\n            <div  *ngIf=\"!item.isEditable\">{{item.description}}</div>\n            <input type=\"text\"  [(ngModel)]=\"item.description\" *ngIf=\"item.isEditable\" class=\"form-control\">\n          </td>\n          <td>\n             <button type=\"button\" class=\"btn btn-info\"  (click)=\"item.isEditable=!item.isEditable\" *ngIf=\"!item.isEditable\">Edit</button>\n             <button type=\"button\" class=\"btn btn-success\" *ngIf=\"item.isEditable\" (click)=\"item.isEditable=!item.isEditable;updateTestCode(item.testName,item.testCode,item.description,item.id)\">Save</button>\n            </td>\n             </tr>\n      </tbody>\n    </table>\n    </div>\n\n    \n<!-- Modal -->\n<div id=\"myModal\" class=\"modal fade\" role=\"dialog\">\n    <div class=\"modal-dialog\">\n  \n      <!-- Modal content-->\n      <div class=\"modal-content\">\n        <div class=\"modal-header\">\n           <h4 class=\"modal-title\">Test Details Form</h4>\n          <button type=\"button\" class=\"close\" data-dismiss=\"modal\">&times;</button>\n        </div>\n        <div class=\"modal-body\">\n        \n              <div class=\"form-group\">\n                <label for=\"name\">Test Name:</label>\n                <input type=\"text\" [(ngModel)]=\"testName\" class=\"form-control\" id=\"name\">\n              </div>\n              <div class=\"form-group\">\n                <label for=\"code\">Test Code:</label>\n                <input type=\"text\" [(ngModel)]=\"testCode\"  class=\"form-control\" id=\"code\">\n              </div>\n              <div class=\"form-group\">\n                  <label for=\"desc\">Test Description:</label>\n                  <textarea type=\"text\" [(ngModel)]=\"testDesc\"  rows=\"4\" class=\"form-control\" id=\"desc\"></textarea>\n                </div>\n          \n        </div>\n        <div class=\"modal-footer\">\n          <button type=\"button\" class=\"btn btn-success\" data-dismiss=\"modal\">Close</button>\n          <button type=\"button\" class=\"btn btn-info\" (click)=\"creattestDetails(testName,testCode,testDesc)\" data-dismiss=\"modal\">Submit</button>\n        </div>\n      </div>\n  \n    </div>\n  </div>\n  "
...
var TestcodeComponent = /** @class */ (function () {
    function TestcodeComponent(dataservice) {
        this.dataservice = dataservice;
        this.getAllTestCodeDetails();
    }
    TestcodeComponent.prototype.creattestDetails = function (testName, testCode, description) {
        var _this = this;
        var obj = { testCode: testCode, description: description, testName: testName };
        this.dataservice.createTestDetails(obj).subscribe(function (data) {
    ...
    TestcodeComponent.prototype.updateTestCode = function (testName, testCode, description, id) {
        var _this = this;
...
var UserdetailsComponent = /** @class */ (function () {
    ...
    UserdetailsComponent.prototype.getuserByid = function () {
        ...
        this.dataservice.getuserByid(sessionStorage.getItem('sponsorId')).subscribe(function (data) {
            ...
            _this.username = data.resultData[0];
            _this.firsname = data.resultData[1];
            _this.lastname = data.resultData[2];
            _this.phone = data.resultData[3];
            _this.email = data.resultData[0];
        });
    };
...
/* harmony import */ var _pagenotfound_pagenotfound_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./pagenotfound/pagenotfound.component */ "./src/app/index/pagenotfound/pagenotfound.component.ts");
/* harmony import */ var _postcodeerror_postcodeerror_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./postcodeerror/postcodeerror.component */ "./src/app/index/postcodeerror/postcodeerror.component.ts");
/* harmony import */ var _final_final_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./final/final.component */ "./src/app/index/final/final.component.ts");
/* harmony import */ var _more_detail_more_detail_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./more-detail/more-detail.component */ "./src/app/index/more-detail/more-detail.component.ts");
/* harmony import */ var _questions_questions_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./questions/questions.component */ "./src/app/index/questions/questions.component.ts");
/* harmony import */ var _address_address_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./address/address.component */ "./src/app/index/address/address.component.ts");
/* harmony import */ var _test_test_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./test/test.component */ "./src/app/index/test/test.component.ts");
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./login/login.component */ "./src/app/index/login/login.component.ts");
/* harmony import */ var _sign_up_sign_up_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./sign-up/sign-up.component */ "./src/app/index/sign-up/sign-up.component.ts");
/* harmony import */ var _index_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./index.component */ "./src/app/index/index.component.ts");
/* harmony import */ var _gaurds_login_guard__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../gaurds/login.guard */ "./src/app/gaurds/login.guard.ts");
/* harmony import */ var _result_result_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./result/result.component */ "./src/app/index/result/result.component.ts");
/* harmony import */ var _person_details_person_details_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./person-details/person-details.component */ "./src/app/index/person-details/person-details.component.ts");
/* harmony import */ var _edit_details_edit_details_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./edit-details/edit-details.component */ "./src/app/index/edit-details/edit-details.component.ts");
/* harmony import */ var _viewresults_viewresults_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./viewresults/viewresults.component */ "./src/app/index/viewresults/viewresults.component.ts");
/* harmony import */ var _login_action_page_login_action_page_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./login-action-page/login-action-page.component */ "./src/app/index/login-action-page/login-action-page.component.ts");
...
var Indexroutes = [
    { path: '', component: _index_component__WEBPACK_IMPORTED_MODULE_9__["IndexComponent"], canActivate: [_gaurds_login_guard__WEBPACK_IMPORTED_MODULE_10__["LoginGuard"]],
        children: [
            { path: 'login', component: _login_login_component__WEBPACK_IMPORTED_MODULE_7__["LoginComponent"] },
            { path: 'login/:id', component: _login_login_component__WEBPACK_IMPORTED_MODULE_7__["LoginComponent"] },
            { path: 'sing-up', component: _sign_up_sign_up_component__WEBPACK_IMPORTED_MODULE_8__["SignUpComponent"] },
            { path: 'personsdetails', component: _person_details_person_details_component__WEBPACK_IMPORTED_MODULE_12__["PersonDetailsComponent"] },
            { path: 'personsdetails/:id', component: _person_details_person_details_component__WEBPACK_IMPORTED_MODULE_12__["PersonDetailsComponent"] },
            { path: 'test', component: _test_test_component__WEBPACK_IMPORTED_MODULE_6__["TestComponent"] },
            { path: 'address', component: _address_address_component__WEBPACK_IMPORTED_MODULE_5__["AddressComponent"] },
            { path: 'address/:id', component: _address_address_component__WEBPACK_IMPORTED_MODULE_5__["AddressComponent"] },
            { path: 'result/:id', component: _result_result_component__WEBPACK_IMPORTED_MODULE_11__["ResultComponent"] },
            { path: 'question', component: _questions_questions_component__WEBPACK_IMPORTED_MODULE_4__["QuestionsComponent"] },
            { path: 'moredetail', component: _more_detail_more_detail_component__WEBPACK_IMPORTED_MODULE_3__["MoreDetailComponent"] },
            { path: 'result', component: _result_result_component__WEBPACK_IMPORTED_MODULE_11__["ResultComponent"] },
            { path: 'edit', component: _edit_details_edit_details_component__WEBPACK_IMPORTED_MODULE_13__["EditDetailsComponent"] },
            { path: 'final', component: _final_final_component__WEBPACK_IMPORTED_MODULE_2__["FinalComponent"] },
            { path: 'not', component: _postcodeerror_postcodeerror_component__WEBPACK_IMPORTED_MODULE_1__["PostcodeerrorComponent"] },
            { path: 'pagenotfound', component: _pagenotfound_pagenotfound_component__WEBPACK_IMPORTED_MODULE_0__["PagenotfoundComponent"] },
            { path: 'final', component: _final_final_component__WEBPACK_IMPORTED_MODULE_2__["FinalComponent"] },
            { path: 'viewresults', component: _viewresults_viewresults_component__WEBPACK_IMPORTED_MODULE_14__["ViewresultsComponent"] },
            { path: 'loginpageaction', component: _login_action_page_login_action_page_component__WEBPACK_IMPORTED_MODULE_15__["LoginActionPageComponent"] }
        ]
    }
];
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.ngOnInit = function () {
        ...
        var params = this.activatedRoute.snapshot.params;
        if (params.id == 1) {
            var someobj = this.sendservice.seconddata;
...
var IndexService = /** @class */ (function () {
    ...
    IndexService.prototype.send = function (user) {
        ...
        return this.http.post(this.server, user).subscribe(function (res) {
            _this.age = res['status'];
            if (_this.age == "Success") {
    ...
    IndexService.prototype.sendone = function (user) {
        ...
        return this.http.post(this.sends, user).subscribe(function (res) {
            if (res['message'] == "Success") {
                ...
                var tests = res['resultData']['testCodes'];
                sessionStorage.setItem('sponsorId', _this.value);
                sessionStorage.setItem('testCodes', _this.tests);
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2luZGV4L3ZpZXdyZXN1bHRzL3ZpZXdyZXN1bHRzLmNvbXBvbmVudC5zY3NzIn0= */"
